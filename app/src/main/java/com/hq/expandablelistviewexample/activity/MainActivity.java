...
import com.hq.expandablelistviewexample.adapter.XExpandableListViewNew;
...
import com.hq.expandablelistviewexample.bean.CollocationChildChildBean;
...
public class MainActivity extends AppCompatActivity implements CollocationListAdapter.OnCheckBoxListener {
    ...
    private List<CollocationBean> collocationList;
            ...
            private void setData() {
                try {
                    ...
                    for (int a = 0; a < collocationList.size(); a++) {
                        List<CollocationChildBean> collocationSkuBeans = collocationList.get(a).getCollocationSkuDoList();
            ...
            private void setData() {
                try {
                    ...
                    for (int a = 0; a < collocationList.size(); a++) {
                        ...
                        List<CollocationChildBean> collocationSkuBeans = collocationPackageBea.getCollocationSkuDoList();
                        for (int b = 0; b < collocationSkuBeans.size(); b++) {
                            CollocationChildBean collocationSkuBean = collocationSkuBeans.get(b);
                            collocationSkuBean.setCheckBox(isCKBAll);

                            List<CollocationChildChildBean> collocationSkuChildBeans = collocationSkuBean.getCollocationSkuChildBeans();
                            for (int ii = 0; ii < collocationSkuChildBeans.size(); ii++) {
                                CollocationChildChildBean collocationSkuChildBean = collocationSkuChildBeans.get(ii);
    ...
    private void initData() {
        ...
        CollocationBean collocation_1 = new CollocationBean();
        CollocationBean collocation_2 = new CollocationBean();
///==============
        ...
        List<CollocationChildChildBean> collocationSkuChildBeans_1 = new ArrayList<>();
        collocationSkuChildBeans_1.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 0, false));
        collocationSkuChildBeans_1.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 1, false));
        collocationSkuChildBeans_1.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));

        List<CollocationChildChildBean> collocationSkuChildBeans_1_0 = new ArrayList<>();
        collocationSkuChildBeans_1_0.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));
        collocationSkuChildBeans_1_0.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));
        collocationSkuChildBeans_1_0.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));

        List<CollocationChildBean> goodsList_1 = new ArrayList<>();
        goodsList_1.add(new CollocationChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", false, collocationSkuChildBeans_1, false));
        goodsList_1.add(new CollocationChildBean("VR PLUS 智能眼镜vr虚拟现实头盔 3D沉浸式 暴风魔镜 vr plus 智能头盔 白色", "http://img15.hqbcdn.com/product/c6/10/c610075082199955a8d5dcf2aa765b17.jpg", false, collocationSkuChildBeans_1_0, false));
...
///==============
        ...
        List<CollocationChildChildBean> collocationSkuChildBeans_2 = new ArrayList<>();
        collocationSkuChildBeans_2.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));
        collocationSkuChildBeans_2.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));
        collocationSkuChildBeans_2.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));

        List<CollocationChildChildBean> collocationSkuChildBeans_2_1 = new ArrayList<>();
        collocationSkuChildBeans_2_1.add(new CollocationChildChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", 2, false));

        List<CollocationChildBean> goodsList_2 = new ArrayList<>();
        goodsList_2.add(new CollocationChildBean("Meizu/魅族 魅蓝 note3 全网通 手机 银白 16GB", "http://img11.hqbcdn.com/product/07/0a/070ac7abd57c6d9251d89547f3d62501.jpg", false, collocationSkuChildBeans_2, false));
        goodsList_2.add(new CollocationChildBean("Uka/优加 Meizu/魅族 魅蓝 note3全覆盖全屏钢化玻璃膜 白色", "http://img8.hqbcdn.com/product/9c/15/9c15571aa92905ea1edafb0a288f1ebb.jpg", false, collocationSkuChildBeans_2_1, false));
...
///==============
    ...
    public void onCheckBoxClick(View v, boolean isCheckBox, int desID, String des, int groupPosition, int childPosition, int childchildPosition) {
        switch (desID) {
            case 0: {//============getGroupView
                CollocationBean collocationPackageBea = collocationList.get(groupPosition);
            ...
            break;
            case 1: {//============getChildView
                CollocationChildBean collocationSkuBea = collocationList.get(groupPosition).getCollocationSkuDoList().get(childPosition);
                collocationSkuBea.setCheckBox(isCheckBox);
                List<CollocationChildChildBean> skuChildBeans = collocationSkuBea.getCollocationSkuChildBeans();
    ...
    private void setChildFormChildFormGroup(boolean isCheckBox, int groupPosition, int childPosition) {
        if (isCheckBox) {
            boolean isAll = true;
            List<CollocationChildChildBean> collocationSkuChildBeans = collocationList.get(groupPosition).getCollocationSkuDoList().get(childPosition).getCollocationSkuChildBeans();
